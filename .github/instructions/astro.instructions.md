...
- Define a documented `Props` interface in frontmatter for every reusable component. Add property-level documentation for non-obvious values, defaults, and rendering behavior.
- Type component imports and helper return values
- Follow [`coding-standards.instructions.md`](coding-standards.instructions.md): comments explain intent and decisions, not obvious markup or script mechanics.
